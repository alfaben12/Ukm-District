		...
		<!-- Shopping table table -->
			<div>
				<div class="row row-grid align-items-center">
					<div class="col-lg-6">
						<form id="methodForm">
							<h3>Tambahkan jenis pengiriman</h3>
							<div class="form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Masukkan tujuan">
							</div>
							<div class="form-group">
	...
	<script>
		$(document).ready(function(){
			$("#methodForm").submit(function(event) {
				...
				$.ajax({
					url: "<?= site_url($this->uri->segment(1)) ?>/methodProccessAdd",
					type: "POST",
					data: $(this).serialize(),
					dataType: "json",
					cache: false,
