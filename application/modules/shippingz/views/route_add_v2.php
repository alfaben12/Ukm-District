		...
		<div class="row">
			...
			<div class="d-flex">
				...
				<div class="btn-group" role="group">
					...
					<a href="<?= site_url($this->uri->segment(1).'/add') ?>" class="btn btn-white btn-icon active">
		...
		<!-- Shopping table table -->
			<div>
				<div class="row row-grid align-items-center">
					<div class="col-lg-6">
						<form id="routeForm">
							<h3>Tambahkan rute</h3>
							<div class="form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Masukkan tujuan">
							</div>
							<div class="form-group">
								<select name="method_id"  data-toggle="select" title="Jenis" class="form-control" style="width:100%">
