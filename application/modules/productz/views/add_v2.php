				...
				<div class="row row-grid align-items-center">
					<div class="col-lg-6">
						<form id="productForm">
							...
							<div class="form-group">
								<input type="file" name="file-1[]" id="file-1" class="custom-input-file" data-multiple-caption="{count} gambar terpilih" multiple />
								<label for="file-1">
							...
							<div class="form-group">
								<input type="number" class="form-control" id="rating" name="rating" placeholder="Masukkan rating (1-5)" max="5">
							</div>
							<div class="form-group">
	...
	<script>
		$(document).ready(function(){
			...
			$("#productForm").submit(function(event) {
				...
				$.ajax({
					url: "<?= site_url() ?>productz/proccessAdd",
					type: "POST",
					data: frm_data,
					dataType: "json",
					cache: false,
