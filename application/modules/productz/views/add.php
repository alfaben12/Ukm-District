                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="file" id="file" name="file" placeholder="Masukkan gambar">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-6">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <div class="form-group">
                                            <input type="checkbox" id="is_diskon" name="is_diskon" placeholder="Diskon?">
                                        </div>
                                    </td>
                                </tr>
                                <tr id="tr_finalPrice">
