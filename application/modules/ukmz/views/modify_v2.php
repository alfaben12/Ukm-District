		...
		<div class="row">
			...
			<div class="d-flex">
				...
				<div class="btn-group" role="group">
					<a href="<?= site_url($this->uri->segment(1).'modify?id='. $this->input->get('id')) ?>" class="btn btn-white btn-icon active">
		...
		<!-- Shopping table table -->
			<div>
				<div class="row row-grid align-items-center">
					<div class="col-lg-6">
						<form id="ukmForm">
							<h3>Edit profile UMKM</h3>
							<div class="form-group">
								<input type="text" class="form-control" id="name" name="name" value="<?= $data[0]['name'] ?>" placeholder="Masukkan UMKM">
                            </div>
                            <div class="form-group">
								<input type="text" class="form-control" id="founder" name="founder" value="<?= $data[0]['founder'] ?>" placeholder="Masukkan nama pemilik">
                            </div>
                            <div class="form-group">
								<input type="text" class="form-control" id="address" name="address" value="<?= $data[0]['address'] ?>" placeholder="Masukkan alamat lengkap">
                            </div>
                            <div class="form-group">
								<input type="text" class="form-control" id="region" name="region" value="<?= $data[0]['region'] ?>" placeholder="Masukkan provinsi">
                            </div>
                            <div class="form-group">
								<input type="text" class="form-control" id="province" name="province" value="<?= $data[0]['province'] ?>" placeholder="Masukkan provinsi">
                            </div>
                            <div class="form-group">
								<input type="text" class="form-control" id="quotes" name="quotes" value="<?= $data[0]['quotes'] ?>" placeholder="Masukkan slogan">
                            </div> 
							<div class="form-group">
                                <textarea name="description" placeholder="Masukkan deskripsi" rows="6"><?= $data[0]['description'] ?></textarea>
							</div>
...
<script>
	...
	toolbar: 'undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | responsivefilemanager',
