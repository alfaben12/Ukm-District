            ...
            <div class="d-flex">
              <div class="btn-group btn-group-nav shadow" role="group" aria-label="Basic example">
                <div class="btn-group" role="group">
                  ...
                  <a href="<?= site_url($this->uri->segment(1).'/add') ?>" class="btn btn-white btn-icon">
                    ...
                    <tbody>
                        ...
                        foreach ($kurir as $key => $val) {
                            ...
                            <tr>
                                ...
                                <td><?= $val['reg_name'] ?></td>
                                <td><?= $val['create_at'] ?></td>
                                <td><a class="btn btn-primary btn-sm" href="<?= site_url() ?><?= $this->uri->segment(1) ?>/modify?id=<?= $val['id'] ?>">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger btn-sm" href="<?= site_url() ?><?= $this->uri->segment(1) ?>/processDelete?id=<?= $val['id'] ?>">Hapus</a></td>
                            </tr>
                            <?php
                        }
                        ?>
