...
<body>
				...
				<div class="row row-grid align-items-center">
                    ...
                    foreach ($kurir as $key => $val) {
						...
						<form id="kurirForm">
							...
							<div class="form-group">
								<select name="region_id"  data-toggle="select" title="Area" class="form-control" style="width:100%">
							...
							<div class="form-group">
								<input type="number" class="form-control" id="phone" name="phone" value="<?= $val['phone'] ?>" placeholder="Masukkan No HP">
							</div>
	...
	<script>
		$(document).ready(function(){
			$("#kurirForm").submit(function(event) {
