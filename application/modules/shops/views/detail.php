			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="<?= site_url('shops') ?>">Shop<span class="lnr lnr-arrow-right"></span></a>
						<a href="<?= site_url('shops') ?>">Produk Detail</a>
					</nav>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6">
					<div class="s_Product_carousel">
                        <div class="single-prd-item">
							<img class="img-fluid" src="<?= base_url('files/') ?>product/<?= $product[0]['image'] ?>" alt="" width="555" height="600">
						</div>    
                        <div class="single-prd-item">
							<img class="img-fluid" src="<?= base_url('files/') ?>product/thank_you.png" alt="" width="555" height="600">
						</div>
					</div>
				</div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.data.product[0]['is_diskon'] == 1) {
						var price = '<strike>Rp. ' + response.data.product[0]['price'] + '</strike> <br/>' +
                        'Rp. ' + response.data.product[0]['final_price'];
                        $('#h2_price').append(price);
					}else{
